class Car {
  constructor(x, y, width, height, dummy=false) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
  ...
  draw(ctx, color="black", sensors=false) {
  ...
  #assessDamage(roadBorders, traffic) {
    for (const borders of roadBorders) {
      if (polysIntersect(this.polygon, borders)) {
        return true;
      }
    }
